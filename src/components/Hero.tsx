...
export default function Hero() {
  return (
    <section className="relative bg-offwhite overflow-hidden" aria-label="Hero">
      {/* background blobs (subtle + balanced) */}
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="border border-black/10 bg-offwhite shadow-sm">
  ...
  hover:bg-beige/90 hover:shadow-md hover:-translate-y-0.5"
                ...
                <Link
                  href="/payinvoice"
                  className="inline-flex items-center justify-center px-8 py-3 text-base font-medium tracking-normal
  border border-beige/70 text-beige shadow-sm
  transform-gpu will-change-transform
  transition-[transform,background-color,box-shadow] duration-200 ease-out
  hover:bg-beige/10 hover:shadow-md hover:-translate-y-0.5"
                >
                  Pay Invoice
                </Link>
              </div>
